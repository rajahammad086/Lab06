//Raja Hammad Mehmood
// This program is a modification of the code given in the book. It deals with the methods employed
// by queues.
public class QueueOfInts {
	...
	/**
	 * Remove and return the front item in the queue. Throws an
